### **[CC Switch:Claude Code、Codex、Gemini CLI、OpenCode 和 OpenClaw 的全方位管理工具](https://github.com/farion1231/cc-switch/blob/main/README_ZH.md)**
...
|                  主界面                   |                  添加供应商                  |
| :---------------------------------------: | :------------------------------------------: |
| ![主界面](https://github.com/user-attachments/assets/cf4368d4-02cf-4bdd-a563-4cdf9fb45a84) | ![添加供应商](https://github.com/user-attachments/assets/68556363-5908-4326-aae2-e861dbab01d0) |

<img width="1870" height="1252" alt="Image" src="https://github.com/user-attachments/assets/cf4368d4-02cf-4bdd-a563-4cdf9fb45a84" />

<img width="1980" height="1284" alt="Image" src="https://github.com/user-attachments/assets/68556363-5908-4326-aae2-e861dbab01d0" />
...
如需了解各项功能的详细使用方法，请查阅 **[用户手册](https://github.com/farion1231/cc-switch/blob/main/docs/user-manual/zh/README.md)** — 涵盖供应商管理、MCP/Prompts/Skills、代理与故障转移等全部功能。
...
从 [Releases](https://github.com/farion1231/cc-switch/releases) 页面下载 `CC-Switch-v{版本号}-macOS.dmg`（推荐）或 `.zip`。
...
从 [Releases](https://github.com/farion1231/cc-switch/releases) 页面下载最新版本的 Linux 安装包：
